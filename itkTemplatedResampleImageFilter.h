 ...
 *
 *=========================================================================*/
#ifndef __itkTemplatedResampleImageFilter_h
#define __itkTemplatedResampleImageFilter_h
...
namespace itk
{
/** \class TemplatedResampleImageFilter
 * \brief Resample an image via a coordinate transform
 *
 * TemplatedResampleImageFilter resamples an existing image through some coordinate
...
template< class TInputImage,
          class TOutputImage,
          class TInterpolatorType,
          class TTransformType  >
class ITK_EXPORT TemplatedResampleImageFilter:
  public ImageToImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef TemplatedResampleImageFilter                             Self;
  ...
  itkTypeMacro(TemplatedResampleImageFilter, ImageToImageFilter);
  ...
  /** TemplatedResampleImageFilter produces an image which is a different size
  ...
  /** TemplatedResampleImageFilter needs a different input requested region than
   * the output requested region.  As such, TemplatedResampleImageFilter needs
...
#endif
protected:
  TemplatedResampleImageFilter();
  ~TemplatedResampleImageFilter() {}
  void PrintSelf(std::ostream & os, Indent indent) const;

  /** TemplatedResampleImageFilter can be implemented as a multithreaded filter.
...
private:
  TemplatedResampleImageFilter(const Self &); //purposely not implemented
...
#include "itkTemplatedResampleImageFilter.txx"
#endif
