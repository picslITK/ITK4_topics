...
public:
  ...
  typedef typename Superclass::ThreadIDType ThreadIDType;
...
private:
  ...
  /** Joint PDF and PDF Derivatives types */
...
#include "itkMattesMutualInformationImageToImageObjectMetric.txx"
#endif
