...
class ITK_EXPORT NeighborhoodNormalizedCrossCorrelationImageToImageMetric:
public ImageToImageMetric<TFixedImage, TMovingImage>
{
public:
  /** Standard class typedefs. */
  typedef NeighborhoodNormalizedCrossCorrelationImageToImageMetric       Self;
  ...
  itkTypeMacro(NeighborhoodNormalizedCrossCorrelationImageToImageMetric, ImageToImageMetric);
...
protected:
  NeighborhoodNormalizedCrossCorrelationImageToImageMetric();
  virtual ~NeighborhoodNormalizedCrossCorrelationImageToImageMetric();
...
private:
  NeighborhoodNormalizedCrossCorrelationImageToImageMetric(const Self &); //purposely not implemented
