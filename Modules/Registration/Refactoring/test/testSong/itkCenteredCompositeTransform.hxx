 ...
 *
 *=========================================================================*/
#ifndef __itkCenteredCompositeTransform_hxx
#define __itkCenteredCompositeTransform_hxx
...
//    unsigned int offset_previous = -1;
    ...
    Superclass::ComputeJacobianWithRespectToParameters(transformedPoint, j);
