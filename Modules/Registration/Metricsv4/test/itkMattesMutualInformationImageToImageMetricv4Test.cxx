...
int TestMattesMetricWithAffineTransform(
  ...
  bool useExplicitJointPDFDerivatives, bool doPreWarp )
{
...
//---------------------------------------------------------
  ...
  typename MetricType::MeasureType measure, measure2=-12345;
...
/*  transformer->SetParameters( parameters );
  ...
  for( unsigned int i = 0; i < numberOfParameters; ++i )
    ...
    std::cout << measurePlus << "\t";
    std::cout << measureMinus << "\t";
...
int itkMattesMutualInformationImageToImageMetricv4Test(int argc, char * argv [] )
{
  ...
  failed = TestMattesMetricWithAffineTransform<ImageType,LinearInterpolatorType>(
    linearInterpolator, useSampling, useExplicitJointPDFDerivatives, doPreWarp );
...
return EXIT_FAILURE;
  ...
  */
  ...
  failed = TestMattesMetricWithAffineTransform<ImageType,BSplineInterpolatorType>(
    bSplineInterpolator, useSampling, useExplicitJointPDFDerivatives, doPreWarp );
