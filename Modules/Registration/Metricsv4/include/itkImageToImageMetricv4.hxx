...
if( (virtualPoint[0] == 0 && virtualPoint[1] == 0) ||
  ...
  {
  std::cout << "TaEMP: mappedMovingPoint: " << mappedMovingPoint << " index: " << index << " valid: " << pointIsValid << " mappedMovingPixelValue: " << static_cast<int>(mappedMovingPixelValue) << " mappedMovingImageGradient: " << mappedMovingImageGradient << std::endl;
  }
*/
  return pointIsValid;
}
