...
bool print = false;
if( static_cast<int>(fixedImagePoint[0]) % 30 == 0 &&
    static_cast<int>(fixedImagePoint[1]) % 30 == 0 )
    {
    std::cout << "ProcSamp: point: " << fixedImagePoint
              << " fixedImageParzenWindowIndex: " << fixedImageParzenWindowIndex
              << " pdfMovingIndex: " << pdfMovingIndex
              << " val: ";
    print = true;
    }
...
if( print )
  std::cout << "mvParzArg: " << movingImageParzenWindowArg << "val: " << val << ", ";
...
/*
static SizeValueType count = 0;
if( count % 10000 == 0 )
{
std::cout << "point: " << fixedImagePoint
          << " pdfMovingIndex: " << pdfMovingIndex << " movingImageGrad: "
          << movingImageGradient << std:: endl<< " cubicBSplineDerivativeValue: " << cubicBSplineDerivativeValue << " derivativeContribution: " << derivativeContribution << std::endl;
}
count++;
*/
    if( associate->m_UseExplicitPDFDerivatives )
