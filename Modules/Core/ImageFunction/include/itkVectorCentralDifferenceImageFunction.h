...
#define ITK_TEMPLATE_VectorCentralDifferenceImageFunction(_, EXPORT, TypeX, TypeY)     \
  namespace itk                                                                  \
  {                                                                              \
  _( 2 ( class EXPORT VectorCentralDifferenceImageFunction< ITK_TEMPLATE_2 TypeX > ) ) \
  namespace Templates                                                            \
  {                                                                              \
  typedef VectorCentralDifferenceImageFunction< ITK_TEMPLATE_2 TypeX >                 \
  VectorCentralDifferenceImageFunction##TypeY;                                       \
  }                                                                              \
  }
...
//    const unsigned int
// VectorCentralDifferenceImageFunction<TInputImage,TCoordRep>::ImageDimension;
#include "Templates/itkVectorCentralDifferenceImageFunction+-.h"
#endif
